...
- [AGENTS.md Template](agents.md) — MEMORY.md privacy rules that govern how USER.md content is used
- [BOOTSTRAP.md Template](bootstrap.md) — how USER.md gets its initial content during first-run
