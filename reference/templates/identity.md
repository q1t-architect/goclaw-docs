...
- [SOUL.md Template](soul.md) — the personality file that gives identity its depth
- [BOOTSTRAP.md Template](bootstrap.md) — how name and emoji are chosen during first-run
