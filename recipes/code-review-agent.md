...
- [Multi-Channel Setup](./multi-channel-setup.md) — expose this agent on Telegram and WebSocket
- [Team Chatbot](./team-chatbot.md) — add the reviewer as a specialist in a team
- [Tools Reference](../reference/) — full built-in tool list and policy options
