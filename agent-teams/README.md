...
1. **[What Are Agent Teams?](./what-are-teams.md)** (82 lines)
   - Team model overview
   - Key design principles
   - Real-world example
   - Comparison with other delegation models

2. **[Creating & Managing Teams](./creating-managing-teams.md)** (169 lines)
...
3. **[Task Board](./task-board.md)** (218 lines)
...
4. **[Team Messaging](./team-messaging.md)** (156 lines)
...
5. **[Delegation & Handoff](./delegation-and-handoff.md)** (297 lines)
...
1. Start with [What Are Agent Teams?](./what-are-teams.md) for conceptual overview
2. Read [Creating & Managing Teams](./creating-managing-teams.md) to set up your first team
3. Learn [Task Board](./task-board.md) to create and manage work
4. Read [Team Messaging](./team-messaging.md) for communication patterns
5. Master [Delegation & Handoff](./delegation-and-handoff.md) for work distribution
