...
- [Agents Overview](../core-concepts/agents-explained.md) — per-agent configuration reference
- [Hooks & Quality Gates](../advanced/hooks-quality-gates.md) — validate agent outputs after reasoning
