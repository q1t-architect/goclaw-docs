...
- [Extended Thinking](../advanced/extended-thinking.md) — deeper reasoning before producing output
- [Exec Approval](../advanced/exec-approval.md) — human-in-the-loop approval for shell commands
