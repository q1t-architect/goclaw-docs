> Bản dịch từ [English version](../../recipes/personal-assistant.md)
...
- [Editing Personality](../agents/editing-personality.md) — tùy chỉnh SOUL.md, IDENTITY.md, USER.md
- [Telegram Channel](../channels/telegram.md) — tài liệu tham khảo cấu hình Telegram đầy đủ
- [Team Chatbot](./team-chatbot.md) — thêm các agent chuyên biệt cho các task khác nhau
- [Multi-Channel Setup](./multi-channel-setup.md) — đặt cùng agent trên Discord và WebSocket
