...
- [Open vs. Predefined](./open-vs-predefined.md) — hiểu khi nào file là theo user hay cấp agent
- [Summoning & Bootstrap](./summoning-bootstrap.md) — cách SOUL.md và IDENTITY.md được LLM tạo ra
