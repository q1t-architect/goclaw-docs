...
> **Lưu ý:** `pruneContextMessages` (PruneStage) **không** nằm trong pipeline chính ở trên. Nó chạy opt-in và tách biệt — chỉ khi `mode: "cache-ttl"` được đặt. Sơ đồ trên phản ánh đường xử lý lịch sử chuẩn.
