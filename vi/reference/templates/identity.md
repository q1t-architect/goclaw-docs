> Bản dịch từ [English version](../../../reference/templates/identity.md)
...
- [SOUL.md Template](soul.md) — file personality cho identity thêm chiều sâu
- [BOOTSTRAP.md Template](bootstrap.md) — tên và emoji được chọn như thế nào trong lần đầu
