> Bản dịch từ [English version](../../core-concepts/how-goclaw-works.md)
...
|------|:-----------:|---------|
| `main` | 2 | Tin nhắn channel và WebSocket request |
| `subagent` | 4 | Tác vụ subagent được spawn |
| `delegate` | 100 | Agent-to-agent delegation |
| `cron` | 1 | Cron job lên lịch |
...
| **Provider Registry** | Quản lý kết nối và thông tin xác thực LLM provider |
| **Tool Registry** | 60+ tool với kiểm soát truy cập dựa trên policy |
...
- [Agents Explained](agents-explained.md) — Tìm hiểu sâu về loại agent và context file
- [Tools Overview](tools-overview.md) — Danh mục tool đầy đủ
