...
Trong v3, hệ thống [Memory 3 tầng](/memory-system) bổ sung consolidation bất đồng bộ: episodic worker trích xuất sự kiện, semantic worker trừu tượng hóa, dreaming worker tổng hợp insight mới — tất cả điều phối bởi DomainEventBus.
