...
const DOC_MAP = {
  ...
  'provider-vertex': docEntry('providers', 'vertex', 'Vertex AI (Google Cloud)', 'Vertex AI (Google Cloud)', 'Vertex AI (Google Cloud)'),
  'provider-bailian': docEntry('providers', 'bailian', 'Bailian', 'Bailian', '百炼'),
  'provider-kimi': docEntry('providers', 'kimi', 'Kimi Coding', 'Kimi Coding (Moonshot)', 'Kimi Coding (Moonshot)'),
  ...
  'permission-matrix': docEntry('advanced', 'permission-matrix', 'Permission Matrix', 'Ma trận phân quyền Agent', 'Agent 权限矩阵'),
  ...
  'webhooks': docEntry('advanced', 'webhooks', 'Webhooks', 'Webhooks', 'Webhooks'),
  'workstations': docEntry('advanced', 'workstations', 'Workstations', 'Workstations', 'Workstations'),
